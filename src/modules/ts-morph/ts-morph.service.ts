...
/**
 * Сервис для глубокого анализа и трансформации TypeScript/JavaScript кода с использованием ts-morph.
 */
...
/**
 * Извлекает значимые символы из кода (классы, функции, интерфейсы и т.д.).
 */
...
/**
 * Извлекает информацию об импортах из файла.
 */
...
/**
 * Удаляет все объявления импортов из кода.
 */
